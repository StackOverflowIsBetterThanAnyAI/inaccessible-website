...
- 1x text content above other text nodes
...
- 1x image of text should be replaced by text
- 1x image has bad alt text
- 4x th elements need scope
- 6x th instead of td
- 1x link relies on color alone
- 8x button has no accessible text
- 1x image not marked as decoration
- 1x text is justified
...
- 1x text animation has no aria attribute
- 1x dl has no dt element
- 16x image has no accessible name
