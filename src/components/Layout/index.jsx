...
const Layout = ({ children }) => (
    <>
        <header className="site__header">
            <Nav />
            <Notice
                message="&#9755; NOTICE: There is risk of serious injury posed by emulating activities performed on this site. Participate at your own discretion."
                level="warning"
            />
        </header>
        ...
        <footer className="site__footer">
            ...
            <section className="site__colophon">
                ...
                <p>
                    ...
                    <a href="https://lilly.art/">N.E.Lilly</a> in the Greater
                    Philadelphia area, circa 2019. Visit the{' '}
                    <Link href="/colophon">Colophon</Link> page for technical
                    details.
                </p>
                <ul>
                    <li>
                        <a href="https://github.com/nelilly/inaccessible-website/">
                            Inaccessible Website GitHub Repository
                        </a>
                    </li>
                    <li>
                        <a href="https://github.com/nelilly/a11y-manual-testing/">
                            a11y-manual-testing GitHub Repository
                        </a>
                    </li>
                    <li>
                        <a href="https://github.com/nelilly/a11y-workflow/">
                            a11y-workflow GitHub Repository
                        </a>
                    </li>
                </ul>
            </section>
            <section className="site__connect">
                ...
                <ul>
                    ...
                    <li>
                        <a
                            href="https://linkedin.com/in/nelilly/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg
                            ...
                            >
                                <path
                                    fill="currentColor"
                                    d="M1.707 0a1.708 1.708 0 11-.004 3.415A1.708 1.708 0 011.707 0zM.234 14.19V4.711h2.945v9.477H.234zm4.792-9.478h2.821v1.295h.04c.393-.746 1.353-1.53 2.785-1.53 2.978 0 3.53 1.961 3.53 4.514v5.198H11.26V9.582c0-1.1-.021-2.515-1.53-2.515-1.531 0-1.764 1.198-1.764 2.433v4.69h-2.94V4.711z"
                                    transform="translate(.479 .48)"
                                />
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a
                            href="https://twitter.com/nelilly/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg
